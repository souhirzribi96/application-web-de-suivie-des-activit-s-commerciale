...
export const verticalMenuItems = [
    new Menu (1, 'Gamme des produits par marques', '/pages/marques', null, 'flask', null, false, 0),
    new Menu (2, 'Activite commecial ', '/pages/activite-commerce', null, 'pencil', null, false, 0),
    new Menu (3, 'Rendez vous ', '/pages/rendez-vous', null, 'calendar-plus-o', null, false, 0),
    new Menu (4, 'Notes ', '/pages/Notes', null, 'sticky-note-o', null, false, 0),
    new Menu (5, 'Contacts', '/pages/contacts', null, 'address-book', null, false, 0),
...
export const horizontalMenuItems = [
    new Menu (1, 'Gamme par produit', '/pages/marques', null, 'flask', null, false, 0),
    new Menu (2, 'Activite commecial ', '/pages/activite-commerce', null, 'pencil', null, false, 0),
    new Menu (3, 'Rendez vous ', '/pages/rendez-vous', null, 'calendar-plus-o', null, false, 0),
    new Menu (4, 'Notes ', '/pages/Notes', null, 'sticky-note-o', null, false, 0),
    new Menu (5, 'Contacts', '/pages/contacts', null, 'users', null, false, 0),
    new Menu (6, 'UI Features', null, null, 'laptop', null, true, 0),
